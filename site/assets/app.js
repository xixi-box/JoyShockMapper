...
const translations = {
  zh: {
    'nav.joycon': 'Joy-Con 映射',
    'nav.djimic': 'DJI Mic',
    'nav.features': '特性',
    'nav.arch': '架构',
    'nav.download': '下载',
    'hero.badge': '社区 GUI 版 · 基于 JoyShockMapper',
    'hero.title1': '把 Joy-Con 变成你的',
    'hero.title2': 'PC 无线输入工具',
    'hero.sub': 'Joy-Con 外部映射 + 陀螺仪瞄准 + 完整按键映射，同屏实时监视你的 DJI Mic 电量与状态 —— 一个便携 EXE，全部搞定。',
    'hero.download': '下载便携版',
    'hero.github': 'View on GitHub',
    'hero.upstream': '上游项目',
    'hero.joycon': 'Joy-Con 映射',
    'hero.mic': 'DJI Mic 状态',
    'hero.mic.live': '实时连接中',
    'focus.joycon.title': 'Joy-Con 外部映射',
    'focus.joycon.desc': '作为 PC 的外部输入/映射工具：陀螺仪瞄准、单击双击、多键组合，按设备自动恢复配置。',
    ...
    'joycon.kicker': 'JOY-CON',
    'joycon.title': 'Joy-Con 外部映射工具',
    'joycon.sub': '把任天堂 Joy-Con 变成 PC 上最灵活的无线输入设备。',
    'jc1.title': '陀螺仪瞄准',
    'jc1.desc': '按住 ZL 启用陀螺仪鼠标移动，精细/快速灵敏度、加速与低速平滑对应原生参数。',
    'jc2.title': '单击 / 双击 / 多键',
    ...
    'arch.ui': '界面层',
    'arch.ui.desc': '窗口、设置、托盘、自启与持久化 · DJI Mic 状态展示',
    'arch.core': '嵌入式核心',
    'arch.core.desc': 'Joy-Con 轮询 · 实时映射 · 陀螺仪 · DJI Mic 协议解析',
  ...
  en: {
    'nav.joycon': 'Joy-Con Mapper',
    'nav.djimic': 'DJI Mic',
    'nav.features': 'Features',
    'nav.arch': 'Architecture',
    'nav.download': 'Download',
    'hero.badge': 'Community GUI · Based on JoyShockMapper',
    'hero.title1': 'Turn your Joy-Con into a',
    'hero.title2': 'wireless PC input tool',
    'hero.sub': 'Joy-Con external mapping, gyro aim and full button mapping — plus a live DJI Mic battery & status monitor, all in one portable EXE.',
    'hero.download': 'Download portable build',
    'hero.github': 'View on GitHub',
    'hero.upstream': 'Upstream',
    'hero.joycon': 'Joy-Con Mapping',
    'hero.mic': 'DJI Mic Status',
    'hero.mic.live': 'Live connected',
    'focus.joycon.title': 'Joy-Con external mapping',
    'focus.joycon.desc': 'Use Joy-Con as an external PC input/mapping tool: gyro aim, single/double taps, multi-key combos, per-device auto-restore.',
    ...
    'joycon.kicker': 'JOY-CON',
    'joycon.title': 'Joy-Con external mapping tool',
    'joycon.sub': 'Turn Nintendo Joy-Con into the most flexible wireless input device on PC.',
    'jc1.title': 'Gyro aiming',
    'jc1.desc': 'Hold ZL to enable gyro mouse. Fine/fast sensitivity, acceleration and low-speed smoothing map to native parameters.',
    ...
    'arch.ui': 'UI Layer',
    'arch.ui.desc': 'Window, settings, tray, autostart & persistence · DJI Mic status view',
    'arch.core': 'Embedded Core',
    'arch.core.desc': 'Joy-Con polling · Live mapping · Gyro · DJI Mic protocol',
